...
d3.csv(datapath).then(function(data) {
    ...
    selectbutton.on("click", function() {
        ...
        // Run functions to create markets on the map
...
function createMarkers(data, map, inputzipcode) {
    ...
    data.forEach(listing => {
        ...
        marker.bindPopup("<h1>" + listing.name + "</h1> <hr> <h3> House Type: " + listing.property_type + "</h1> <hr> <h3> Listing Price: $"+listing.price + "</h1> <hr> <h3>") 
